...
<section class="page-section page-section--white">
	<div class="container">
		<div class="section-intro">
			<div class="eyebrow"><?php the_field( 'cri_services_eyebrow' ); ?></div>
			<h2 class="section-h section-h--sm"><?php matchcredit_title( 'cri_services_titre' ); ?></h2>
		</div>

		<div class="why-edit-grid">
			<?php foreach ( array( 'cri_service_1', 'cri_service_2', 'cri_service_3' ) as $i => $service_key ) :
